...
class FormAuteur():
    def __init__(self,adhèrent) -> None:
        ...
        self.framChercher=tk.LabelFrame(self.root,text="chercher par auteur",fg="chartreuse",bg="white", font='Roman 20 bold ',bd=2,padx=20,pady=10)
        self.framChercher.pack(expand=1)
        #enter valeur
        self.labelNom=tk.Label(self.framChercher,text='auteur du  livre :',font='Roman 20 bold')
